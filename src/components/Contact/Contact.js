...
function Communication() {
    ...
    <form className="contact row g-3">
        ...
        <div className="col-md-4">
            ...
            <input type="text" className="form-control is-valid" id="ValidationServer02" value="Mark" required />
            <div className="valid-feedback">
                Thank You for your input!
            </div>
        </div>
        <div className="col-md-4">
            <label for="ValidationServer03" class="form-label">Valid Email Address</label>
            <input type="text" className="form-control is-valid" id="ValidationServer03" value="Mark" required />
            <div className="valid-feedback">
                Thank You for your input!
            </div>
        </div>
